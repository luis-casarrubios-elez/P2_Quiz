...
//Nombre de fichero donde se guardan las preguntas.
...
//
// Al arrancar la aplicación, esta variable contiene las cuatro preguntas
 ...
 * existe, y se producirá error ENOENT. En este caso se salva el
...
/**
 * Devuelvo un clon del quiz almacenado en la posición dada.
 *
 * Para clonar el quiz se usa stringify + parse.
 *
 * @param id Clave que identifica el quiz a devolver.
 *
 * @returns {question, answer} Devuelve el onjeto quiz de la posición dada
 */
